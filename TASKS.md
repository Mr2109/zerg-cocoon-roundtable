...
> 基线：Web 版 2.1.0（`<volume-path>`——功能对齐参照）
> 设计：虫族主 git `docs/项目文档/v2.5.8/设计-v2.5.8-集装箱-圆桌派Rust重写-20260903.md`（十二章——含 M1-M7 自审）
...
> Web 版代码 = 翻译源（读——不启动）——终态无 Web——全 Rust 界面（虫族 UI 集装箱）
...
### T8-1 ✅ 虫族 UI 虫茧模块（2026-09-03/04——拆 a/b/c 三批——集装箱上船）
...
- M3：✅ T8-1 完成（2026-09-04——集装箱上船——平台两级语义——虫族 UI 里可用）
