...
//! 设计：虫族主 git docs/项目文档/v2.5.8/设计-v2.5.8-虫茧-圆桌派Rust重写-20260903.md
...
pub mod errors; // 统一错误 RtError 四分类（L3——2026-09-04）
pub mod logging; // 日志系统（JSONL+errors 双落盘——L1 2026-09-04）
